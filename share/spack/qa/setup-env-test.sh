...
contains 'True' spack -c config:ccache:true python -c "print(ctx.config.get('config:ccache'))"
contains 'True' spack -C "$SHARE_DIR/qa/configuration" python -c "print(ctx.config.get('config:ccache'))"
