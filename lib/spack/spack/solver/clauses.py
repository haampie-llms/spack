...
class _Head:
    """Names of the ``attr`` facts that express spec clauses in the HEAD of a rule.

    They are the first argument of ``attr``, and clause generation builds the functions as
    ``AspFunction("attr", (<name>, ...))``.
    """
