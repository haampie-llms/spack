...
class Spec:
    ...
    def _disjoint_node_attributes_reason(self, other: "Spec") -> Optional[spack.error.SpecError]:
        ...
        for self_variants, other_variants in (
            (self.variants, other.variants),
            (self.propagated_variants, other.propagated_variants),
        ):
            for name, other_variant in other_variants.items():
    ...
    def _merge_variants(self, other: "Spec") -> bool:
        """Add the variants of other, set and propagated, merging the ones already present.
        Never raises."""
        changed = False
        for self_variants, other_variants in (
            (self.variants, other.variants),
            ...
            for name, other_variant in other_variants.items():
                ...
                if self_variant is None:
                    self_variants[name] = other_variant.copy()
                    changed = True
                else:
